...
{\small SAP B1 Consultant | ERP Implementation Specialist | Crystal Reports | Business Analysis | MIS Graduate}\\[2pt]
...
% ===== HAKKIMDA =====
\section{HAKKIMDA}
{\small Sakarya Üniversitesi Yönetim Bilişim Sistemleri mezunuyum. SAP Business One Uygulama Danışmanlığı alanında staj ve tam zamanlı pozisyonlarda toplam 1 yıllık uçtan uca SAP B1 danışmanlığı deneyimi kazandım. Analiz, tasarım, geliştirme, canlıya geçiş, raporlama ve sistem entegrasyonu süreçlerinde aktif sorumluluk üstlendim.

SAP B1 ekosisteminde müşteri ihtiyaç analizi, Blueprint hazırlama, Crystal Reports ile raporlama, SQL sorgu optimizasyonu, kurulum, konfigürasyon ve canlı geçiş süreçlerinde deneyim sahibiyim. Kariyerime SAP danışmanlığı alanında derinleşerek ve SAP Joule AI çözümlerini entegre ederek devam etmeyi hedefliyorum.}
...
{\small
\textbf{Profesyonel E-Spor Kariyeri} -- (2020 -- 2021) -- 7 ulusal turnuvada 5 şampiyonluk, 1 Türkiye 2.'liği (TESFED Türkiye Kupası) ve 1 profesyonel lig deneyimi (Zula Süper Lig). 2 turnuvada MVP ödülü. Tüm turnuvalarda IGL (In-Game Leader) olarak takım yönetimi, strateji belirleme ve kriz anlarında karar alma sorumluluğunu üstlendim.
}
